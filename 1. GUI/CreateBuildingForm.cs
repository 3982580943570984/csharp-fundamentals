...
namespace Studying
{
    public partial class CreateBuildingForm : Form
    {
        ...
        private void Insert_Click(object sender, System.EventArgs e)
        {
            if (isValidated()) {
                if (NoParameters.Checked)
                    Program.buildings.Add(new Building());
                else if (OneParameter.Checked)
                    Program.buildings.Add(new Building(city: CityTextBox.Text));
                else if (TwoParameters.Checked)
                    Program.buildings.Add(new Building(
                ...
                MessageBox.Show("Здание создано");
            } else {
                MessageBox.Show("Выбранные параметры отсутствуют или введены некорректно");
            }
        }
