...
namespace Studying
{
    public partial class ModifyBuildingForm : Form
    {
        ...
        public ModifyBuildingForm(int index): this() {
            this.index = index;
            Building building = (Building) Program.buildings[index];
        ...
        private void Insert_Click(object sender, System.EventArgs e)
        {
            if (IsValidated())
            {
                Program.buildings[index] = new Building(city: CityTextBox.Text,
                ...
                MessageBox.Show("Здание изменено");
            } else
            {
                MessageBox.Show("Введенные параметры введены некорректно");
            }
        }
