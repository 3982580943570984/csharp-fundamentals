...
namespace Studying
{
    public class Building : IComparable
    {
        ...
        public Building(string city): this() => City = city;
        ...
        public int CompareTo(object? obj)
        {
            ...
            Building? otherBuilding = obj as Building;
            if (otherBuilding != null)
                return Volume.CompareTo(otherBuilding.Volume);
            else
                throw new ArgumentException("Объект не является Building");
        }
    }
}
